...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Navbar principal */
        .main-navbar {
            background: linear-gradient(135deg, #15401b 0%, #1e5729 50%, #2d7a38 100%);
            box-shadow: 0 4px 20px rgba(21, 64, 27, 0.3);
            padding: 0.5rem 0;
            position: sticky;
            top: 0;
            z-index: 1000;
        ...
        .cart-badge {
            ...
            top: -5px;
            right: -5px;
            background: linear-gradient(135deg, #c28e00, #e6a800);
            color: #15401b;
            font-size: 0.75rem;
            font-weight: 700;
            padding: 4px 8px;
            border-radius: 50%;
            box-shadow: 0 2px 8px rgba(194, 142, 0, 0.5);
        ...
        /* Footer */
        .main-footer {
            background: linear-gradient(135deg, #15401b 0%, #1e5729 100%);
            color: #fff;
            padding: 50px 0 20px;
            margin-top: auto;
        }
...
<body>
    ...
    <nav class="navbar navbar-expand-lg main-navbar">
        <div class="navbar-container">
            <!-- Logo y Marca -->
            <a href="<?php echo e(url('/pedidos')); ?>" class="logo-container">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <div class="user-welcome">
                        <span><i class="fas fa-user"></i> Bienvenid@ <?php echo e(Auth::user()->name); ?></span>
                    </div>
                <?php endif; ?>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-menu ms-auto">
                    <?php if(auth()->guard()->guest()): ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownProductos">
                                <li><a class="dropdown-item" href="<?php echo e(route('categorias.producto', 4)); ?>"><i class="fas fa-tools"></i> Ferretería</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('categorias.producto', 3)); ?>"><i class="fas fa-umbrella-beach"></i> Material de playa</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('categorias.producto', 2)); ?>"><i class="fas fa-box-open"></i> Otros</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link cart-link" href="<?php echo e(route('carrito.index')); ?>">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->is('productos*') ? 'active' : ''); ?>" href="<?php echo e(route('productos.index')); ?>">
                                <i class="fas fa-boxes"></i> Productos
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->is('categorias*') ? 'active' : ''); ?>" href="<?php echo e(route('categorias.index')); ?>">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownPedidos">
                                <li>
                                    <a class="dropdown-item<?php echo e(request()->is('pedidos') && !request()->is('pedidos/historial') ? ' active' : ''); ?>"
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle<?php echo e(request()->is('usuarios*') || request()->is('register*') ? ' active' : ''); ?>"
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownUsuarios">
                                <li>
                                    <a class="dropdown-item<?php echo e(request()->is('usuarios') ? ' active' : ''); ?>"
                                        href="<?php echo e(route('usuarios.index')); ?>">
                                        <i class="fas fa-list-ul"></i> Ver Usuarios
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item<?php echo e(request()->is('register*') ? ' active' : ''); ?>"
        ...
        <div class="footer-content">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 footer-section">
                    ...
                    <p><a href="<?php echo e(url('/')); ?>"><i class="fas fa-chevron-right"></i> Inicio</a></p>
                    <p><a href="<?php echo e(route('categorias.producto', 4)); ?>"><i class="fas fa-chevron-right"></i> Ferretería</a></p>
                    <p><a href="<?php echo e(route('categorias.producto', 2)); ?>"><i class="fas fa-chevron-right"></i> Material de playa</a></p>
                    <p><a href="<?php echo e(route('carrito.index')); ?>"><i class="fas fa-chevron-right"></i> Carrito</a></p>
                </div>
...
<?php /**PATH C:\xampp\htdocs\dulce-contigo-final\resources\views/layouts/app.blade.php ENDPATH**/ ?>