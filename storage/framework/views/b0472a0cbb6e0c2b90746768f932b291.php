        ...
        <div class="col-md-10">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="btn" style="background:rgba(18, 33, 61, 1); color:rgba(246, 253, 254, 1); font-weight:600;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle" id="usuariosTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><span class="badge" style="background:rgba(246, 253, 254, 1); color:rgba(18, 33, 61, 1); border:1px solid rgba(18, 33, 61, 0.1);">#<?php echo e($usuario->id); ?></span></td>
                                    <td><span class="fw-semibold" style="color:rgba(18, 33, 61, 1);"><?php echo e($usuario->name); ?></span></td>
                                    <td><?php echo e($usuario->email); ?></td>
                                    <td><?php echo e($usuario->created_at ? $usuario->created_at->format('d/m/Y') : 'N/A'); ?></td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="<?php echo e(route('usuarios.edit', $usuario->id)); ?>" class="btn btn-sm" style="background:rgba(217, 140, 82, 1); color:rgba(18, 33, 61, 1);" title="Editar">
                                            ...
                                            <form action="<?php echo e(route('usuarios.destroy', $usuario->id)); ?>" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este usuario?')">
                                                ...
                                                <button type="submit" class="btn btn-sm" style="background:rgba(18, 33, 61, 1); color:rgba(246, 253, 254, 1);" title="Eliminar" <?php echo e(auth()->id() == $usuario->id ? 'disabled' : ''); ?>>
