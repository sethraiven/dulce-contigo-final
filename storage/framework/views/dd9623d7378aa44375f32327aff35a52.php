...
<div class="container">
    <div class="search-header text-center">
        ...
        <p class="text-muted">Buscando: <strong>"<?php echo e($query); ?>"</strong></p>
        
        <div class="row justify-content-center mt-3">
            <div class="col-md-6">
                <form action="<?php echo e(route('productos.buscar')); ?>" method="GET" class="d-flex shadow-sm" style="border-radius: 50px; overflow: hidden; border: 2px solid rgba(18, 33, 61, 0.1);">
                    <input type="text" name="query" class="form-control border-0 px-4" placeholder="Buscar otro producto..." value="<?php echo e($query); ?>" required style="font-size: 1.1rem; border-radius: 0;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <a href="<?php echo e(url('/')); ?>" class="btn btn-outline-dark"><i class="fas fa-arrow-left"></i> Volver al inicio</a>
        <span class="text-muted"><?php echo e($productos->count()); ?> productos encontrados</span>
    </div>
    ...
    <?php if($productos->isEmpty()): ?>
        <div class="text-center py-5">
            ...
            <a href="<?php echo e(url('/')); ?>" class="btn mt-3" style="background: rgba(18, 33, 61, 1); color: white;">Ver todo el catálogo</a>
        </div>
    <?php else: ?>
            ...
            <div class="producto-card">
                ...
                <div class="btns-group">
                    <a href="#" class="btn btn-ver-producto" 
                       ...
                       data-categoria="<?php echo e($producto->categoria->nombre ?? 'Sin categoría'); ?>"
                       data-stock="<?php echo e($producto->stock ?? ''); ?>"
                       >
                       Ver
                    </a>
                    <button type="button" class="btn-carrito" title="Agregar al carrito" onclick="agregarAlCarrito(<?php echo e($producto->id); ?>, '<?php echo e($producto->nombre); ?>', <?php echo e($producto->precio); ?>, '<?php echo e($producto->imagen ?? ''); ?>')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dulce-contigo-final\resources\views/productos/resultados.blade.php ENDPATH**/ ?>