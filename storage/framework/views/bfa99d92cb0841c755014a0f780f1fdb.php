...
unset($__errorArgs, $__bag); ?>" id="name" name="name" value="<?php echo e(old('name', $usuario->name)); ?>" required>
                            </div>
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" value="<?php echo e(old('email', $usuario->email)); ?>" required>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="<?php echo e(route('usuarios.index')); ?>" class="btn px-4" style="background:rgba(246, 253, 254, 1); color:rgba(18, 33, 61, 1); border:1px solid rgba(18, 33, 61, 0.2);">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dulce-contigo-final\resources\views/usuarios/edit.blade.php ENDPATH**/ ?>