    ...
    <div class="container mt-4">
          ...
          <div class="row justify-content-center mb-4">
              <div class="col-md-8 col-lg-6">
                  <form action="{{ route('productos.buscar') }}" method="GET" class="d-flex shadow-lg" style="border-radius: 50px; overflow: hidden; border: 2px solid rgba(217, 140, 82, 0.5); background: white;">
